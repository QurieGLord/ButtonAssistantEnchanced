...
NS.defaults = {
	...
	keybindFont = "Numeric",
	keybindFontSize = 12,
	keybindUseAssistantAction = false,
	...
	showCooldown = true,
	showBorder = true,
	borderStyle = "classic", -- "classic", "blizzardDark", "dark"
	...
	effectsOnlyInCombat = true,
			effectModelVersion = 6,
	effectNextReadyPulseEnabled = true,
		effectReadyBounceEnabled = false,
		effectReadyFlashEnabled = true,
		effectReadyPulseEnabled = true,
		effectGCDReadyEnabled = true,
		effectGCDReadyBounceEnabled = false,
		effectGCDReadyFlashEnabled = true,
		effectGCDReadyPulseEnabled = false,
		effectGCDReadyColor = "White",
	...
	avadaBorderStyle = "classic", -- "classic", "blizzardDark", "dark"
		avadaCustomCooldownText = true,
		avadaCooldownFont = "Numeric",
		avadaCooldownFontSize = 12,
		avadaCooldownFontOutline = "OUTLINE",
		avadaEffectReadyFlashEnabled = true,
		avadaEffectReadyPulseEnabled = true,
		avadaEffectReadyBounceEnabled = false,
		avadaEffectReadyColor = "Gold",
		avadaDetached = false,
	avadaX = 0,
	avadaY = -180,
	avadaColumns = 6,
